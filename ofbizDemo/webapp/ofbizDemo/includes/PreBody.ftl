      ...
      <div class="row">
        <div class="col-sm-12">
          <ul id="page-title" class="breadcrumb">
            ...
            <li>
                 <a href="<@ofbizUrl>FindOfbizDemo</@ofbizUrl>">Find</a>
            </li>
            <li>
                <a href="<@ofbizUrl>AddOfbizDemoFtl</@ofbizUrl>">FTL</a>
            </li>
            <li class="active"><span class="flipper-title">${uiLabelMap.TitleM}</span></li>
            <li class="pull-right">
